...
Esse projeto é uma coleção de scripts python para scrap e geração de pubs.
...
- Crie um ambiente virtual via venv do python `python3 -m venv venv`
- Habilitar o ambiente virtual virtual `source venv/bin/activate`
- Se você estiver utilizando o windows, o comando para habilitar o ambiente virtual é diferente `venv\Scripts\activate.bat`
